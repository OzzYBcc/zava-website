    ...
    <div className="w-full">
      <section className="py-24 bg-background transition-colors duration-300">
        <div className="container mx-auto px-4 lg:px-8">
          ...
          <FadeInSection>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-24">
              <div className="text-center">
                ...
                <h3 className="text-2xl font-bold mb-4 text-foreground">Client-Focused</h3>
                <p className="text-muted-foreground">
              ...
              <div className="text-center">
                ...
                <h3 className="text-2xl font-bold mb-4 text-foreground">Results-Driven</h3>
                <p className="text-muted-foreground">
          ...
          <FadeInSection>
            <div className="bg-secondary rounded-lg p-12 text-center transition-colors duration-300">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-5xl mx-auto">
                <div>
                  ...
                  <p className="text-muted-foreground text-sm">Honest, transparent communication in every interaction</p>
                </div>
                <div>
                  <h3 className="text-xl font-bold mb-2 text-foreground">Innovation</h3>
                  <p className="text-muted-foreground text-sm">Staying ahead with cutting-edge solutions</p>
                </div>
                <div>
                  <h3 className="text-xl font-bold mb-2 text-foreground">Collaboration</h3>
                  <p className="text-muted-foreground text-sm">Working together as true partners</p>
                </div>
                <div>
                  <h3 className="text-xl font-bold mb-2 text-foreground">Excellence</h3>
                  <p className="text-muted-foreground text-sm">Delivering exceptional quality every time</p>
                </div>
              </div>
            </div>
          </FadeInSection>
